// theidealprogen/src/components/cl/CLSectionOrder.tsx
"use client";

import * as React from "react";
import type { SectionKeyT } from "@/lib/cl-types";

const ALL: SectionKeyT[] = ["header","dateLine","recipient","greeting","opener","body","highlights","closing","signature"];

export default function CLSectionOrder({
  order,
  hidden,
  onChange,
}: {
